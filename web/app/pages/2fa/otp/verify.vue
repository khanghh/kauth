  ...
  <div class="bg-white rounded-xl shadow-lg overflow-hidden">
    <div class="p-8">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 mt-2">We sent a code to your email <b>{{ emailOrPhone }}</b></p>
      </div>
      ...
      <form method="POST" class="space-y-6" id="otpForm">
        ...
        <div class="flex justify-between items-center text-sm">
          <span class="text-gray-600">Didn’t get the code?</span>
          <button type="submit" name="resend" value="true" :disabled="!canResend">
            <span :class="resendLinkClass">Resend</span>
            <span v-if="!canResend" class="text-gray-600"> in {{ countdown }}s</span>
          </button>
        </div>
...
const resendLinkClass = computed(() =>
  canResend.value
    ? 'text-blue-600 hover:text-blue-500 font-medium'
    : 'text-gray-400 pointer-events-none font-medium'
)
