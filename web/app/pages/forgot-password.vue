      ...
      <div class="px-6 sm:px-10 py-10">
        <div v-if="emailSent">
          <div class="text-center mb-6">
            <div class="w-24 h-24 mx-auto bg-green-100 flex items-center justify-center rounded-full mb-4">
              <Icon name="fa7-solid:envelope-circle-check" class="text-green-500 text-5xl" aria-hidden="true" />
            </div>
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Reset Link Sent</h1>
          ...
          <div class="mt-6 flex flex-row gap-3 justify-center">
            <a href="/login"
              class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-3.5 px-4 rounded-lg transition duration-200">
        ...
        <div v-else>
          ...
          <form method="POST" class="space-y-6">
            ...
            <div class="pt-2">
              <button type="submit"
                class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3.5 px-4 rounded-lg transition duration-200 flex items-center justify-center">
                <Icon name="fa7-solid:paper-plane" class="mr-2" />
                Send Reset Link
              </button>
            </div>
