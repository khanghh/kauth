    ...
    <div ref="dropdownRoot" class="relative">
      ...
      <div
        ...
        <div class="py-2">
          ...
          <a href="#"
            class="flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
            <Icon name="fa7-solid:gear" class="mr-3 text-gray-400" />
            Account Settings
          </a>
          <a href="#"
            class="flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
            <Icon name="fa7-solid:bell" class="mr-3 text-gray-400" />
            Notifications
          </a>
        </div>
...
const userInitial = computed(() => (props.user?.displayName?.trim()?.[0] ?? 'U').toUpperCase())
